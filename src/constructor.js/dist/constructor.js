  ...
  window.Constructor._init_page = function(hash_, head) {
    ...
    if (params) {
      ...
      _fn1 = function(p) {
        ...
        val = _p[1];
        if (name && val) {
          return this.page_vars[name] = val;
        }
      };

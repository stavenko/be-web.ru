...
DATABASES = {
    'default': {
        ...
        'NAME': 'beweb',                      # Or path to database file if using sqlite3.
    ...
    'powerdns':{
        ...
        'PASSWORD': 'uFeznKeLJ0Z7',                  # Not used with sqlite3.
        'HOST': '',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
        'OPTIONS':{
...
SECRET_KEY = '1n%1o=$-*x)c-25j%l(yn*&^#!_z8wa#2r5i^+r(66exn4n^g='
...
MIDDLEWARE_CLASSES = (
    ...
    'constructor.middleware.MongoDBMiddleware',
)

ROOT_URLCONF = 'sop.urls'

TEMPLATE_DIRS = (
"/var/www/src/sop/templates",
